...
#Scope refers to the region of a program where a name (identifier) is recognized. If a name is not in the current scope, Python will search for it in outer scopes using the LEGB rule.
